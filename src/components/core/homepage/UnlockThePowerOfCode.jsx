...
function UnlockThePowerOfCode() {
  ...
  return (
      <div className='py-8 p-2 sm:px-[13%] flex flex-col mx-auto items-center text-white justify-start gap-10'>
          ...
          <div className='relative sm:h-36 flex flex-col justify-center items-center w-[100%]'>
              <div className='sm:absolute flex lg:flex-row sm:flex-row flex-col gap-2 md:gap-10 sm:translate-y-[30%]'>
                  {
