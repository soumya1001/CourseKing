...
function CourseCard({course,currentCard,setCurrentCard}) {
  return (
    <div className={`bg-richblack-800 flex flex-col gap-5 justify-between transition duration-150 hover:backdrop-blur-md hover:bg-opacity-90 shadow-[-20px_20px_300px_-70px_rgba(255,214,10,1)] border-spacing-1 border-richblack-5`} onClick={()=>setCurrentCard(course.heading)}>
        <div className='p-5'>
